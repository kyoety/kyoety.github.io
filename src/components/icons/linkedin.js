...
const IconLinkedin = () => (
    <>
        ...
        <svg
            ...
            viewBox="0 0 456.935 456.935"
            style={{ enableBackground: "new 0 0 456.935 456.935" }}
            xmlSpace="preserve"
            stroke="currentColor"
        >
            <g>
            <g>
                <path
                d="M121.806,192.07c-0.635-5.329-4.504-10.232-11.699-10.232c-23.364,0-46.723-0.043-70.074-0.787
                ...
                />
                <path
                d="M66.728,27.292c-0.835,0.089-1.607,0.271-2.354,0.477C28.026,29.42,1.824,58.527,0.067,95.06
                ...
                />
                <path
                d="M429.917,204.415c-40.248-60.626-106.729-79.247-176.14-65.227c-0.676-8.559-1.874-17.083-3.133-25.588
